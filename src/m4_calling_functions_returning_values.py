...
def run_test_digits_in_cube():
    ...
    # Test 5
    expected5 = 10
    answer5 = digits_in_cube(4)
    print("Test 5", expected5)
    print("actual", answer5)

    # Test 6
    expected6 = 9
    answer6 = digits_in_cube(6)
    print("Test 6", expected6)
    print("actual", answer6)
    # Test 7
    expected7 = 9
    answer7 = digits_in_cube(3)
    print("Test 7", expected7)
